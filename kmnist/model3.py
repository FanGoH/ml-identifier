...
from keras.layers import Conv2D, MaxPooling2D,Lambda,AveragePooling2D
...
filepath = "./ModelCheckPoints4/saved-model-{epoch:04d}.hdf5"
checkpoint = ModelCheckpoint(filepath, monitor='val_acc', verbose=1, save_best_only=False, save_freq=2480)
...
name = f"./ModelCheckPoints4/model - {date.today()}"
name1 = name + ".json"
name2 = name + ".h5"
